...
class Transaction(SQLModel, table=True):
    ...
    transaction_number: str = Field(default="", unique=True, index=True)  # 交易流水號
    account_id: uuid.UUID  # 使用 UUID 與 Account 模型一致
    ...
    related_account: Optional[uuid.UUID] = None  # 關聯帳戶 UUID
